...
- TypeScript 5.6.3 with strict mode + Next.js 15 (App Router), React 18, Tailwind CSS, ShadCN UI (Radix UI), Lucide Reac (002-movie-discovery-quiz)
- Local cache (browser localStorage) for quiz results, JSON files for any server-side data (002-movie-discovery-quiz)

## Recent Changes

- 002-movie-discovery-quiz: Added TypeScript 5.6.3 with strict mode + Next.js 15 (App Router), React 18, Tailwind CSS, ShadCN UI (Radix UI), Lucide Reac
